...
import 'package:credit_card_ui/credit_card_ui_animation.dart';
...
const Map<CardType, String> CardTypeIconAsset = <CardType, String>{
  ...
  CardType.elo: 'assets/elo.png',
  CardType.hipercard: 'assets/hipercard.png',
};

class CreditCardUiWidget extends StatefulWidget {
  const CreditCardUiWidget(
      {Key? key,
      ...
      required this.onCreditCardUiWidgetChange,
  ...
  final void Function(CreditCardBrand) onCreditCardUiWidgetChange;
  ...
  @override
  _CreditCardUiWidgetState createState() => _CreditCardUiWidgetState();
}

class _CreditCardUiWidgetState extends State<CreditCardUiWidget>
  ...
  @override
  void didUpdateWidget(covariant CreditCardUiWidget oldWidget) {
  ...
  Widget build(BuildContext context) {
    ...
    widget.onCreditCardUiWidgetChange(CreditCardBrand(cardType));
