...
class FloatingIconLeadingNavBar extends StatefulWidget {
  final Color? navBarColor;
  final List Items;
  final bottomPadding;
  final double? navBarHeight;
  final MainAxisAlignment itemsAlignment;
  const FloatingIconLeadingNavBar(
      {Key? key,
      this.navBarColor,
      required this.Items,
  ...
  @override
  _FloatingIconLeadingNavBarState createState() =>
      _FloatingIconLeadingNavBarState();
}

class _FloatingIconLeadingNavBarState extends State<FloatingIconLeadingNavBar> {
  @override
